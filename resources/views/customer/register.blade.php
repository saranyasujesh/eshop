						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									@foreach($categories as $category)
										<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#man" role="tab">{{ $category->category_name }}</a></li>
									@endforeach
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											@foreach($categories as $category)
											@foreach($category->products->trending_item as $prd)
					...
					@foreach($product as $prd)
						...
						<div class="single-product">
							...
							<div class="product-content">
								<h3><a href="product-details.html">{{ $prd->name}}</a></h3>
								<div class="product-price">
									<span class="old">{{ $prd->actual_price }}</span>
									<span>{{ $prd->reduced_price }}</span>
								</div>
							</div>
						</div>
						@endif
