...
<head>
	...
	<!-- Jquery Ui -->
    <link rel="stylesheet" href="{{ asset('public/customers/css/jquery-ui.css') }}">
	<!-- Nice Select CSS -->
						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										@foreach($categories as $category)
											<li><input type="checkbox" class="cats" name="categories[]" id="cats" value="{{ $category->id }}"> {{ $category->category_name }}</li>
										@endforeach
									</ul>
								</div>
								<!--/ End Single Widget -->
										...
										<div class="price-filter-inner">
											...
											<div class="price_slider_amount">
												<div class="label-input">
													...
													<div class="row">
														<div class="col-6">
															<input type="text" class="pamount" id="minamount" name="minamount" style="width:80px; border:1px solid black;"/>
														</div>
														<div class="col-6">
															<input type="text" class="pamount" id="maxamount" name="maxamount" style="width:80px; border:1px solid black;"/>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										@foreach($brands as $brand)
											<li><input type="checkbox" class="brands" name="brands[]" value="{{ $brand->id }}"> {{ $brand->brand_name }}</li>
										@endforeach
									</ul>
								</div>
								<!--/ End Single Widget -->
