...
<head>
	...
	<!-- Bootstrap -->
    <link rel="stylesheet" href="{{ asset('public/customers/css/bootstrap.min.css') }}">
	...
	@php
		$bannerImageUrl = url('storage/app/public/banner/'.$banner->banner_image);
	@endphp
	<style>
						...
						<div class="text-inner">
							<div class="row">
								<div class="col-lg-7 col-12">
									<div class="hero-text">
										<h1><span>{{ $banner->heading }} </span>{{ $banner->category }}</h1>
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									@foreach($categories as $category)
										<li class="nav-item"><a class="nav-link @if($loop->first) active @endif" data-toggle="tab" href="#cat-{{ $category->id }}" role="tab">{{ $category->category_name }}</a></li>
									@endforeach
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent"> 
								<!-- Start Single Tab -->
								@foreach($categories as $category)
									<div class="tab-pane @if($loop->first) show active @endif fade" id="cat-{{ $category->id }}" role="tabpanel">
														...
														<div class="single-product">
															<div class="product-img">
																<a href="product-details.html">
																	<img class="default-img" src="{{ url('storage/app/public/products/main_images/'.$trending->main_image) }}" style="width:100%; height:100%;" alt="#">
																	<img class="hover-img" src="{{ url('storage/app/public/products/main_images/'.$trending->main_image) }}" style="width:100%; height:100%;" alt="#">
																</a>
															...
															<div class="product-content">
																<h3><a href="product-details.html">{{ $trending->name }}</a></h3>
																<div class="product-price">
																	<span>{{ "Rs.".$trending->reduced_price }}</span>
																</div>
															</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						<img src="{{ url('storage/app/public/banner/'.$banner->banner_image) }}" alt="#" width="600" height="370">
						<div class="content">
							<p>{{ $banner->category }}</p>
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						<img src="{{ url('storage/app/public/banner/'.$bnr->banner_image) }}" alt="#">
						<div class="content">
							<p>{{ $bnr->category }}</p>
							<h3>{{ $bnr->heading }}</h3>
							<a href="#" class="btn">Shop Now</a>
                ...
                <div class="col-12">
					...
					@foreach($hotitems as $hotitem)
						...
						<div class="single-product">
							<div class="product-img">
								<a href="product-details.html">
									<img class="default-img" src="{{ url('storage/app/public/products/main_images/'.$hotitem->main_image) }}" alt="#">
									<img class="hover-img" src="{{ url('storage/app/public/products/main_images/'.$hotitem->main_image) }}" alt="#">
							...
							<div class="product-content">
								<h3><a href="product-details.html">{{ $hotitem->name}}</a></h3>
								<div class="product-price">
									<span class="old">{{ $hotitem->actual_price }}</span>
									<span>{{ $hotitem->reduced_price }}</span>
								</div>
							</div>
						</div>
					@endforeach
