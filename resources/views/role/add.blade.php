                        ...
                        @foreach($menus as $menu)
                            <div class="col-12 col-sm-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="icheck-success d-inline">
                                            <input type="checkbox" class="checkSub mainItem" id="menu-{{ $menu->id }}" name="posted[]" value="{{ $menu->id }}">
                                            ...
                                            @foreach($menu->submenus as $submenu)
                                                <div class="row">
                                                    <div class="icheck-success d-inline ml-3">
                                                        <input type="checkbox" class="checkSub subItem-{{ $menu->id }}" id="menu-{{ $submenu->id }}" name="posted[]" value="{{ $submenu->id }}">
